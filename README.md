...
| Safe editor defaults | Starts the editor with RF Channel at 15 and LED Brightness at 20 while still allowing users to change the guarded dropdown values |
